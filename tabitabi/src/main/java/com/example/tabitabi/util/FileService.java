package com.example.tabitabi.util;
...
public class FileService {
     ...
     * @return 저장된 파일명
     */
    public ProductImage saveFile(MultipartFile mfile) {
        ...
        return new ProductImage(originalFilename, savedFilename + ext, mfile.getSize());
    }
    ...
    public boolean deleteFile(String fullpath) {
        ...
        log.info("Deleting file at path: {}", fullpath.toString());
        // 해당 파일이 존재하면 삭제
        if (delFile.isFile()) {
            delFile.delete();
